...
def parse_args():
    ...
    parser.add_argument('--dataoutputdir', '--dataoutputdir', type=str, default='', metavar='PATH', help='directory to save output in')
    parser.add_argument('-o', '--output', type=str, default='', metavar='PATH', help='output suffix for 2D detections')
    args = parser.parse_args()
    return args


def the_main_thing(args):
